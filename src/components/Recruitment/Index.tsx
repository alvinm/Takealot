...
const Recruitment = (props:any) =>{
    ...
    const callFactDriverForecastWeekly = () =>{
        ...
        .then(data=>{
            ...
            setCombined([
                { type:"column",name: "Forecast", data: forecastSeries,color: "#aaa",  },
                { type:"line", name: "Utilised", data: actualSeries,  color:"blue"},
                ...
                <IonRow>
                    ...
                    >
                        <IonRow className="ion-padding ion-text-center text-hover" style={{color:"#fff",backgroundColor:"#aaa",borderRadius:"30px",height:"56px"}}>
                            <IonCol className="ion-text-left" size="3"><IonIcon icon={settingsOutline} className="size-24"></IonIcon></IonCol>
                            <IonCol className="ion-text-center">{dashboardView? <div>Admin</div>:<div>Dashboard</div>}</IonCol>
                        </IonRow>
                    </IonCol>
                </IonRow>
            </div>
